 ...
 * Uebungsblatt 1
 * Aufgabe 1.2: Apache Flink
 */
public class AufgabeTableAPI {

    /**
     * Die folgenden Tabellen entsprechen dem jeweiligen Schema aus Aufgabe 1.1
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table dTeile = lieferungen.select("PNr").minus(lieferungen.join(lieferungen.as("L, T, P, M")).where("(LNr != L || TNr != T) && PNr === P").select("PNr"));
        DataSet<Long> teileDataD = tEnv.toDataSet(dTeile, Long.class);
        teileDataD.print();
        //////////
    ...
    public static void initialize() {
        ...
        lieferungen = tEnv.fromDataSet(
                env.fromElements(
                        ...
                        new Lieferung(2, 103, 1, 50),
                        new Lieferung(3, 114, 1, 20),
                        new Lieferung(4, 112, 3, 50),
                        new Lieferung(5, 102, 2, 70),
                        new Lieferung(6, 142, 1, 50),
                        new Lieferung(7, 123, 1, 35),
                        new Lieferung(8, 123, 3, 40),
                        new Lieferung(9, 102, 2, 90),
                        new Lieferung(10, 114, 1, 50),
                        new Lieferung(11, 114, 1, 100),
                        new Lieferung(12, 112, 3, 60),
                        new Lieferung(13, 132, 2, 10),
                        new Lieferung(14, 124, 1, 80),
                        new Lieferung(15, 102, 1, 68),
                        new Lieferung(16, 143, 3, 70),
                        new Lieferung(17, 112, 2, 50),
                        new Lieferung(18, 102, 1, 50),
                        new Lieferung(19, 134, 1, 20),
                        new Lieferung(20, 141, 3, 70),
                        new Lieferung(21, 115, 2, 10),
                        new Lieferung(22, 111, 1, 50),
                        new Lieferung(23, 103, 1, 80),
                        new Lieferung(24, 112, 3, 50),
                        new Lieferung(25, 131, 4, 100),
                        new Lieferung(26, 133, 1, 60),
                        new Lieferung(27, 143, 1, 60),
                        new Lieferung(28, 141, 3, 40),
                        new Lieferung(29, 102, 2, 35),
                        new Lieferung(30, 112, 1, 55),
                        new Lieferung(31, 114, 1, 40),
                        new Lieferung(32, 116, 3, 90)
                ), "LNr, TNr, PNr, Menge");
